...
const Netflix = () => {
  ...
  return (
    <div
    className={`sm:w-[32%] my-[2%] sm:my-0 w-[90%] h-[32%] mx-auto sm:h-[100%] py-2 border border-gray-500 sm:mx-[2%] group rounded-3xl overflow-hidden  hover:scale-110 duration-500 relative`}
    >
      <div>
        <img alt="img" src={netflix} />
      </div>

      <div className="bg-gradient-to-t from-pink-600 sm:pb-[1%] group-hover:translate-y-6 translate-y-full absolute bottom-0 left-0 duration-200">
