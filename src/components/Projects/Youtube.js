    ...
    >
      ...
      <div className="bg-gradient-to-t from-pink-600 group-hover:-translate-y-[112%] duration-200">
        <p className="text- bg-black bg-opacity-50  px-[15%] mb-5">
          ...
          <img
            className=" bg-white rounded-full border-2 mt-8 b-2 mb-25 border-stone-800 hover:border-purple-400 opacity-0 group-hover:opacity-80 h-12 group-hover:-translate-y-1  w-12  mx-[10vh]  justify-center shadow-2xl cursor-pointer"
